	                ...
	                <div class="container">
                        <form action="{{ route('update-cart') }}" method="post">
                            ...
                            <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="quantity-col">
                                                    <div class="cart-product-quantity">
                                                        ...
                                                        <input type="number" name="quantities[{{ $item->id }}]" class="form-control" value="{{ $item->quantity }}" min="1" max="{{$item->stock}}" step="1" data-decimals="0" required>

                                                    </div><!-- End .cart-product-quantity -->
                                                </td>
                                                <td class="total-col">${{ $item->quantity * $item->product->price }}</td>
                                                <td class="remove-col"><button type="button" class="btn-remove" data-id="{{ $item->id }}"><i class="icon-close"></i></button></td>
                                            </tr>
                                            @endif
                                            @endforeach
                                        </tbody>
                                        ...
                                        <table class="table table-summary">
                                            <tbody>
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="free-shipping" name="shipping" class="custom-control-input" value="free" data-cost="0" @if ($shippingFee == 0) checked @endif>
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="standard-shipping" name="shipping" class="custom-control-input" value="standard" data-cost="10" @if ($shippingFee == 10) checked @endif>
                                                ...
                                                <tr class="summary-shipping-row">
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="express-shipping" name="shipping" class="custom-control-input" value="express" data-cost="20" @if ($shippingFee == 20) checked @endif>
                                ...
                                @else
                                    <div class="col-12"><h2 class="text-center">Your cart is empty</h2></div>
                                @endif
                            </div><!-- End .row -->
                        </form>
	                </div><!-- End .container -->
