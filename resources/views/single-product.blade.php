                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="/{{$product->thumbnail}}" data-zoom-image="/{{$product->thumbnail}}" alt="product image">
                                        ...
                                        @if($galleryImages)
                                            ...
                                            <a class="product-gallery-item active" href="#" data-image="/{{ $galleryImage }}" data-zoom-image="/{{ $galleryImage }}">
                                                <img src="/{{ $galleryImage }}" alt="product side">
                                            </a>
                                            @endforeach
                                        @endif
