                                ...
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" type="email" class="form-control" id="email" name="email" :value="old('email')" autofocus required>
                                        </div><!-- End .form-group -->
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" :value="old('phone')" autocomplete="phone">
                                        </div><!-- End .form-group -->
